...
public class MainGUI extends JFrame {
    ...
    public void generateHomePage() {
        ...
        panelA.repaint();
        panelA.revalidate();
        panelA.setLayout(new FlowLayout(FlowLayout.CENTER, 3, 3));
        ...
        Image image = getImage(controller.getFieldText("mainScreenImage"), new Dimension((int)leftDim.getWidth()-6,(int)leftDim.getHeight()-75));
        JLabel imageLabel = new JLabel();
        imageLabel.setPreferredSize(new Dimension((int)leftDim.getWidth()-6,(int)leftDim.getHeight()-75));
    ...
    public void generateSettingsPage() {
        ...
        for (int i = 0; i < bound; i++) {
            ...
            // editButtonsButton.addActionListener(new );
        ...
        panelA3.setPreferredSize(new Dimension(630, 500));
